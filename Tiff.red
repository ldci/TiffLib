Red [
	...
	File: 	 %Tiff.red
	Tabs:	 4
	Rights:  "Copyright (C) 2016-2022 Francois Jouen. All rights reserved."
	License: {
...
#include %TiffObject.red ; for Tiff definitions
...
"Get the image description for each subfile included in the file"
	...
	while [i <= numberOfEntries ] [
    	...
    	getTiffTagValue; get the tag value OK
		i: i + 1
	]
]
...
readTiffImageData: func [page [integer!]] [
	imageData: copy #{}					; a copy for each page
	getTiffImageType page			; image type in TImage
	readTiffFileDirectory page		; read file dir and process all tags
	; for image stripes 
...
; Show Tiff image
tiff2RedImage: func [return: [image!]] [
